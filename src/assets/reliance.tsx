...
//           <div className="flex items-center justify-center gap-4 mb-4"><img src="/reliance-industries-ltd.webp" alt="Reliance Solar" className="h-12 w-auto" /><h1 className="text-4xl font-bold text-gray-900">HJT Solar System Pricing</h1></div>
