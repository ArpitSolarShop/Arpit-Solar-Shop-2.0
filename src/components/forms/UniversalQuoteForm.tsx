...
const UniversalQuoteForm = ({
    ...
    const logoSrc = config?.logo || (category === "Tata" ? "/Tata Power Solar.webp" : category === "Reliance" ? "/Reliance.webp" : category === "Shakti" ? "/Shakti Solar.webp" : category === "Hybrid" ? "/Hybrid.webp" : "/logo.webp");
